...
WHERe MONTH(ss.REFERENCE_DATE) BETWEEN ".$drop_month_start." AND ".$drop_month_end." AND YEAR(ss.REFERENCE_DATE) BETWEEN ".$drop_year_start." AND ".$drop_year_end." GROUP BY ss.REFERENCE_DATE,po1.NAV_UNIT,po1.NAV,po1.RETURN_RATE,po2.NAV_UNIT,po2.NAV,po2.RETURN_RATE,po1.CREATE_DATE,po2.CREATE_DATE ORDER BY ss.REFERENCE_DATE DESC";
