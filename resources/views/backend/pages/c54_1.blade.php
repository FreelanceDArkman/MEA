        ...
        <div class="col-xs-12 col-sm-5 col-md-5 col-lg-8">
            <ul id="sparks" class="">
                <li class="sparks-info">
                    ...
                    <a href="{{action('C54_1Controller@getAdd')}}" class="btn bg-color-green txt-color-white"><i class="fa fa-plus"></i> สร้างหมวดหมู่คำถามคำตอบ</a>
                </li>
                <li class="sparks-info">
...
//        $("#all_data").hide();
        ...
        $("#mainCheck,.mainCheck").on("click",function(){$(".item_checked").not(this).prop('checked', this.checked);});
...
//                                alert(textStatus);
        ...
        $("#mea_edit").on('click',function(){
            ...
            if(checkcount > 1 || checkcount  == 0){
                ...
                window.location.href = "/admin/faqcate/edit/" + $(".item_checked:checked").val();
            }
...
//        var NEWS_CATE_ID = $("#news_topice_select").val();
        ...
        var jsondata = {pagesize : page_size,PageNumber:p, NEWS_TOPIC_FLAG:NEWS_TOPIC_FLAG};

        MeaAjax(jsondata,"faqcate/getall",Render);
    };
...
//        var NEWS_CATE_ID = $("#news_topice_select").val();
        ...
        var jsondata = {pagesize : 10,PageNumber:1, NEWS_TOPIC_FLAG:NEWS_TOPIC_FLAG};
