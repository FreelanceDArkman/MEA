                ...
                <div>
                    ...
                    <div class="widget-body fuelux">
                        ...
                        <div class="step-content">
                            <form class="form-horizontal" action="{{ action('UserGroupController@postEditUserGroup') }}" id="fuelux-wizard" method="post">
                                {!! csrf_field() !!}
                                <div class="step-pane active" id="step1">
                                    ...
                                    <fieldset>
                                        ...
                                        {{--</div>--}}
                                        <input type="hidden" name="USER_PRIVILEGE_ID" value="{{$user_group->USER_PRIVILEGE_ID}}">
                                        <div class="form-group">
                                            <label class="col-md-2 control-label">ชื่อกลุ่มผู้ใช้</label>
                                            <div class="col-md-10 col-lg-6">
                                                <input class="form-control" name="user_group_name" type="text" value="{{$user_group->USER_PRIVILEGE_DESC}}">
