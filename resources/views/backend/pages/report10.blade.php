                    ...
                    <form  id="comment-form_darkman" class="smart-form" novalidate="novalidate">
                        ...
                        <fieldset>
                            {{--<div class="row">--}}
                                ...
                                {{--</section>--}}
                                {{--<section class="col col-4">--}}
                                {{--<label class="label"><input type="checkbox" id="check_plan" value="plan"> สถานะของสมาชิก</label>--}}
                                {{--<label class="input">--}}

                                {{--<select name="plan" id="plan" class="form-control">--}}
                                {{--<option value="">เลือกประเภท</option>--}}
                                {{--<option value="0">ทกุประเภท</option>--}}
                                {{--@if($planlist)--}}
                                {{--@foreach($planlist as $plan)--}}
                                {{--@if($plan->USER_STATUS_ID == "05" || $plan->USER_STATUS_ID == "06")--}}
                                {{--<option value="{{$plan->USER_STATUS_ID}}">{{$plan->STATUS_DESC}}</option>--}}
                                {{--@endif--}}
                                {{--@endforeach--}}
                                {{--@endif--}}
                                {{--</select>--}}
                            ...
                            <div class="row">
                                <section class="col col-4">
                                    <label class="label"><input type="checkbox" checked="checked" style="display: none;" id="check_date" value="date_start"> ระบุช่วงเวลา</label>
                    ...
                    <div>
                        ...
                        <div class="widget-body">
                            <p class="report-title">
                                รายงานจำนวนผู้ติดตั้ง Application บน Mobile
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $('#export_search').on('click',function(){
                ...
                window.location.href =  "report10/exportsearch?EmpID=" + EmpID +"&depart=" + depart + "&plan=" + plan + "&date_start=" +date_start + "&date_end=" + date_end + '&check_name=' + check_name+ '&check_depart=' + check_depart+ '&check_plan=' + check_plan+ '&check_date=' + check_date;
            ...
            $('#btn_search').on('click',function(){
                ...
                MeaAjax(jsondata,"report10/search",RenderSearch);
