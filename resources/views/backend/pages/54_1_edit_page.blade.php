                                ...
                                <fieldset>
                                    <section>
                                        ...
                                        <label class="input">
                                            ...
                                            <input type="text" disabled="disabled" style="background-color: #f1f1f1;" value="{{$Topicdata->FAQ_CATE_ID }}" id="FAQ_CATE_ID" name="FAQ_CATE_ID" placeholder="รหัสหมวดหมู่">
                                        </label>
                                    </section>
                                    ...
                                    <section>
                                        <label class="input">
                                            ...
                                            <input type="text" id="FAQ_CATE_NAME" value="{{$Topicdata->FAQ_CATE_NAME}}" name="FAQ_CATE_NAME" placeholder="ชื่อหมวดหมู่">
                                        </label>
                                    </section>
                                </fieldset>
                                ...
                                <fieldset>
                                    ...
                                    <section style="margin-top: 15px;margin-left: 20px;">
                                        <div class="inline-group">
                                            <label class="radio">
                                                <input type="radio"  {{$logyes}} class="FAQ_CATE_FLAG" name="FAQ_CATE_FLAG" checked="" value="0">
                                                <i></i>เปิด</label>
                                            <label class="radio">
                                                <input type="radio" {{$logno}} class="FAQ_CATE_FLAG" name="FAQ_CATE_FLAG" value="1">
                                                <i></i>ปิด</label>
                                ...
                                <fieldset>
                                    ...
                                    <section >
                                        ...
                                        <label class="input">
                                            ...
                                            <input type="text" value="{{$Topicdata->FAQ_CATE_KEYWORD}}" id="FAQ_CATE_KEYWORD" name="FAQ_CATE_KEYWORD" placeholder="คีย์เวิร์ดในการค้นหา ข้อมูล">
                                        </label>
                                    </section>
                                    ...
                                    <div class="row">
                                        ...
                                        <section class="col col-6">
                                            ...
                                            <label class="input">
                                                ...
                                                <input type="text" value="{{$Topicdata->FAQ_CONTACT_DEPT}}" name="FAQ_CONTACT_DEPT"  id="FAQ_CONTACT_DEPT" placeholder="หน่วยงานติดต่อ"  >
                                            </label>
                                        </section>
                                        ...
                                        <section class="col col-6">
                                            ...
                                            <label class="input">
                                                <input type="text" value="{{$Topicdata->FAQ_CONTACT_PHONE}}" name="FAQ_CONTACT_PHONE"   id="FAQ_CONTACT_PHONE" placeholder="หมายเลขติดต่อ" >
