                    ...
                    <form  id="comment-form_darkman" class="smart-form" novalidate="novalidate">
                        ...
                        <fieldset>
                            <div class="row">
                                ...
                                <section class="col col-4">
                                <label class="label"><input type="checkbox" id="check_plan" style="display: none" checked="checked" value="plan">   เลือกแผนการลงทุน</label>
                                <label class="input">
                            ...
                            <div class="row">
                                <section class="col col-4">
                                    <label class="label"><input type="checkbox" style="display: none" checked="checked" id="check_date" value="date_start"> ระบุช่วงเวลา</label>
                    ...
                    <div>
                        ...
                        <div class="widget-body">
                            <p class="report-title">
                                ...
                                รายงานผลการเลือกแผนการลงทุนในแต่ละแบบ
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $('#export_search').on('click',function(){
                ...
                window.location.href =  "report11/exportsearch?EmpID=" + EmpID +"&depart=" + depart + "&plan=" + plan + "&date_start=" +date_start + "&date_end=" + date_end + '&check_name=' + check_name+ '&check_depart=' + check_depart+ '&check_plan=' + check_plan+ '&check_date=' + check_date;
            ...
            $('#btn_search').on('click',function(){
                ...
                MeaAjax(jsondata,"report11/search",RenderSearch);
