                        ...
                        <li>
                            ...
                            <div class="smart-timeline-content">
                                <p class="import_title">
                                    <a href="javascript:void(0);"><strong>เป็นเมนูนําเข้าข้อมูลอัตราสมทบของสมาชิก</strong></a>
                                </p>
                                <p>
                ...
                success: function(data){
                    if(data.success){
                        ...
                        AlertSuccess("ข้อมูลได้ถูก update เรียบร้อยแล้ว", function(){
                            window.location.href = "extendrate";
