    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $('#export_search').on('click',function(){
                ...
                window.location.href =  "report7/exportsearch?EmpID=" + EmpID +"&depart=" + depart + "&plan=" + plan + "&date_start=" +date_start + "&date_end=" + date_end + '&check_name=' + check_name+ '&check_depart=' + check_depart+ '&check_plan=' + check_plan+ '&check_date=' + check_date;
            ...
            $('#btn_search').on('click',function(){
                ...
                MeaAjax(jsondata,"report7/search",RenderSearch);
