        ...
        {{--<div class="col-xs-12 col-sm-5 col-md-5 col-lg-8">--}}
            {{--<ul id="sparks" class="">--}}
                {{--<li class="sparks-info">--}}
                    ...
                    {{--<a href="{{action('C54_2Controller@getAdd')}}" class="btn bg-color-green txt-color-white"><i class="fa fa-plus"></i> สร้างหัวข้อถาม-ตอบ</a>--}}
                {{--</li>--}}
                {{--<li class="sparks-info">--}}
                ...
                <section>
                    ...
                    <label class="select">
                        <select class="form-control" id="news_topice_select">
                            ...
                            <option value="คส.">งานควบคุมระบบบัญชีสมาชกิและสิทธิประโยชน์(คส.)</option>
                            <option value="บป.">งานบัญชีการเงิน วิเคราะห์และประเมินผลการลงทุน (บป.)</option>
                    ...
                    <header role="heading">
                        <ul class="nav nav-tabs pull-left in">
                            ...
                            <li class="active">
                                ...
                                <a data-toggle="tab" href="#hr1" class="data-tab" data-val="0"> <i class="fa fa-lg fa-arrow-circle-o-down"></i> <span class="hidden-mobile hidden-tablet"> New </span> </a>

                            </li>

                            <li>
                                <a data-toggle="tab" href="#hr2" class="data-tab" data-val="1"> <i class="fa fa-lg fa-arrow-circle-o-up"></i> <span class="hidden-mobile hidden-tablet"> Pending  </span> </a>
                            </li>
                            <li>
                                <a data-toggle="tab" href="#hr3" class="data-tab" data-val="2"> <i class="fa fa-lg fa-arrow-circle-o-up"></i> <span class="hidden-mobile hidden-tablet"> Closed  </span> </a>
                            </li>
...
//                                alert(textStatus);
        ...
        $("#mea_edit").on('click',function(){
            ...
            if(checkcount > 1 || checkcount  == 0){
                ...
                window.location.href = "/admin/faqtopic/edit/" + $(".item_checked:checked").val();
            }
    ...
    function PageRender(){
        ...
        MeaAjax(jsondata,"cmail/getall",Render);
    };
