...
<script type="text/javascript">
        ...
        function gendedit(){
            $(".btn_edit_list").on('click',function(){
                ...
                var FUND_PLAN_TIME_CHANGE_PER_YEAR = $("#FUND_PLAN_TIME_CHANGE_PER_YEAR" + ID).val();
                var FUND_PLAN_CHANGE_PERIOD = $("#FUND_PLAN_CHANGE_PERIOD" + ID).val();
                var SAVING_RATE_TIME_CHANGE_PER_MONTH = $("#SAVING_RATE_TIME_CHANGE_PER_MONTH" + ID).val();
                var SAVING_RATE_CHANGE_PERIOD = $("#SAVING_RATE_CHANGE_PERIOD" + ID).val();
                ...
                MeaAjax(jsondata,"/admin/con4/editsave",function(data){
                    if(data.success){
        ...
        function  getlist(){
            ...
            MeaAjax(json,"/admin/con4/getlist",function(data){
