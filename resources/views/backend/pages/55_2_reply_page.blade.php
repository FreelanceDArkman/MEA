                                ...
                                <fieldset>
                                    <section>
                                        ...
                                        <label class="input">
                                            ...
                                            <input type="text"  value="{{$Topicdata->INFM_EMAIL}}" id="INFM_EMAIL" value="" name="INFM_EMAIL" placeholder="อีเมล์ผู้รับ:">
                                        </label>
                                    </section>
                                    <section>
                                    ...
                                    <section>
                                        <label class="input">
                                            ...
                                            <input type="hidden" value='<p style="font-size: 20px">เรียนท่านสมาชิก</p><p style="font-size: 20px">ตามที่ท่านสมาชิกได้สอบถามข้อมูล ดังข้อมูลอ้างอิงต่อไปนี้</p><p style="font-size: 18px"><strong>เลขที่อ้างอิงคำถาม :</strong> {{$Topicdata->INFM_ID}}</p><p style="font-size: 18px"><strong>วันที่สอบถาม : </strong>{{get_date($Topicdata->INFM_DATE) }}</p><div style="font-size: 18px"><p> <strong>รายละเอียดคำถาม : </strong></p><p>{{$Topicdata->INFM_DETAIL}}</p></div><br/><hr/><br/><br/><br/><br/><p>ส่วนตอบข้อมูล</p><br/><br/><br/><br/><hr/><br/><p style="font-size: 18px">ขอแสดงความนับถือ</p><p style="font-size: 20px">กองทุนสำรองเลี้ยงชีพพนักงานการไฟฟ้านครหลวง ซึงจดทะเบียนแล้ว</p>' id="hddata"/>
