                    ...
                    <form  id="comment-form_darkman" class="smart-form" novalidate="novalidate">
                        ...
                        <fieldset>
                            <div class="row">
                                ...
                                <select name="plan" id="re_type" class="form-control" >
                                <option value="1">ข้อมูลประโยชน์สมาชิก</option>
                                <option value="2">ข้อมูลเปรียบเทียบเงินกองทุนและเงินบำเหน็จ</option>
...
//                date_start=$('#year_start').val() + '.' +$('#month_start').val();
                ...
                var url = "report9/exportsearch";
                if($('#re_type').val() == 1){

                }else {
                    url = "report9/exportsearch2";

                }
                window.location.href =  url + "?EmpID=" + EmpID +"&depart=" + depart + "&plan=" + plan + "&date_start=" +date_start + "&date_end=" + date_end + '&check_name=' + check_name+ '&check_depart=' + check_depart+ '&check_plan=' + check_plan+ '&check_date=' + check_date;
            ...
            $('#btn_search').on('click',function(){
                ...
                var url = "report9/search";
                if($('#re_type').val() == 1){
                    $('.report-title').html('รายงานข้อมูลผลประโยชน์สมาชิก');
                }else {
                    url = "report9/search2";
                    $('.report-title').html('รายงานข้อมูลเปรียบเทียบเงินกองทุนและเงินบำเหน็จ');
                }
...
//                date_start=$('#year_start').val() + '.' +$('#month_start').val();
                ...
                MeaAjax(jsondata,url,RenderSearch);
