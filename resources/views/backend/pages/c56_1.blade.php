        ...
        <div class="col-xs-12 col-sm-5 col-md-5 col-lg-8">
            <ul id="sparks" class="">
                <li class="sparks-info">
                    ...
                    <a href="{{action('C56_1Controller@getAdd')}}" class="btn bg-color-green txt-color-white"><i class="fa fa-plus"></i> สร้างแบบประเมินความเสี่ยง</a>
                </li>
                {{--<li class="sparks-info">--}}
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if(data.ret == "1"){
                                ...
                                window.location.href = '/admin/risk';
                            }
...
//                                alert(textStatus);
        ...
        $("#mea_edit").on('click',function(){
            ...
            if(checkcount > 1 || checkcount  == 0){
                ...
                window.location.href = "/admin/risk/edit/" + $(".item_checked:checked").val();
            }
