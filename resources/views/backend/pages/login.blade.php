...
<head>
    <meta charset="utf-8" />
    <title>การไฟฟ้านครหลวง | Admin Login</title>
...
<div class="logo">
    <a href="{{ url('admin') }}">
        <img src="{{ asset('backend/assets/pages/img/logo.png') }}" alt="" /> </a>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<div class="content">
    <!-- BEGIN LOGIN FORM -->
    <form class="login-form" action="{{ action('Auth\AdminAuthController@checkLogin') }}" method="post">
        {!! csrf_field() !!}
...
<!-- END LOGIN -->
<!-- BEGIN COPYRIGHT -->
<div class="copyright"> 2016 &copy; การไฟฟ้านครหลวง - Admin Dashboard. </div>
<!-- END COPYRIGHT -->
<!--[if lt IE 9]>
