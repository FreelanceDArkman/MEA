        ...
        <div class="col-xs-12 col-sm-5 col-md-5 col-lg-8">
            <ul id="sparks" class="">
                <li class="sparks-info">
                    ...
                    <a href="{{action('C52_1Controller@getAdd')}}" class="btn bg-color-green txt-color-white"><i class="fa fa-plus"></i> สร้างแผนการลงทุน</a>
                </li>
                <li class="sparks-info">
...
//                                alert(textStatus);
        ...
        $("#mea_edit").on('click',function(){
            ...
            if(checkcount > 1 || checkcount  == 0){
                ...
                window.location.href = "/admin/chooseplan/edit/" + $(".item_checked:checked").val();
            }
    ...
    $(document).ready(function() {
        ...
        MeaAjax(jsondata,"chooseplan/getall",Render);
