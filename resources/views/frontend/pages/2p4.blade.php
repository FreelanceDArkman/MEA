...
@section('content')
    ...
    <div class="row">
        <!-- Blog Sidebar -->
        <div class="col-md-3">
            <div class="headline-v2 bg-color-light"><h2>{{ getGoupName($data,2) }}</h2></div>
            <!-- Tags v2 -->
            ...
            {{--<div class="tab-v1">--}}
                {{--<ul class="nav nav-tabs">--}}
                    ...
                    {{--@if($sortby == 1 || $sortby == null)--}}
                        {{--<li class="active"><a href="/fundregulations/1" >มาใหม่</a></li>--}}
                        {{--<li><a href="/fundregulations/2" >เปิดดู</a></li>--}}
                        {{--<li><a href="/fundregulations/3" >ดาวโหลด</a></li>--}}
                    {{--@elseif($sortby == 2)--}}
                        {{--<li ><a href="/fundregulations/1" >มาใหม่</a></li>--}}
                        {{--<li class="active"><a href="/fundregulations/2"  >เปิดดู</a></li>--}}
                        {{--<li><a href="/fundregulations/3" >ดาวโหลด</a></li>--}}
                    {{--@elseif($sortby == 3)--}}
                        {{--<li ><a href="/fundregulations/1" >มาใหม่</a></li>--}}
                        {{--<li ><a href="/fundregulations/2"  >เปิดดู</a></li>--}}
                        {{--<li class="active"><a href="/fundregulations/3" >ดาวโหลด</a></li>--}}
                    {{--@endif--}}
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    @if($sortby== 1 || $sortby == 2)
                                        <th>จํานวนการดูข้อมูล</th>
                                        <th>วันที่ดูข้อมูลล่าสุด</th>
                                    @else
                                        <th>จำนวนการดาวน์โหลด</th>
                                        <th>วันที่ดาวน์โหลดข้อมูลล่าสุด</th>
                                    @endif
