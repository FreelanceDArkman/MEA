            ...
            {{--<div class="tab-v1">--}}
                {{--<ul class="nav nav-tabs">--}}
                    ...
                    {{--@if($sortby == 1 || $sortby == null)--}}
                        {{--<li class="active"><a href="/economic/1" >มาใหม่</a></li>--}}
                        {{--<li><a href="/economic/2" >เปิดดู</a></li>--}}
                        {{--<li><a href="/economic/3" >ดาวโหลด</a></li>--}}
                    {{--@elseif($sortby == 2)--}}
                        {{--<li ><a href="/economic/1" >มาใหม่</a></li>--}}
                        {{--<li class="active"><a href="/economic/2"  >เปิดดู</a></li>--}}
                        {{--<li><a href="/economic/3" >ดาวโหลด</a></li>--}}
                    {{--@elseif($sortby == 3)--}}
                        {{--<li ><a href="/economic/1" >มาใหม่</a></li>--}}
                        {{--<li ><a href="/economic/2"  >เปิดดู</a></li>--}}
                        {{--<li class="active"><a href="/economic/3" >ดาวโหลด</a></li>--}}
                    {{--@endif--}}
