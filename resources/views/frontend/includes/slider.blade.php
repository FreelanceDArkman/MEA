...
<div id="layerslider" style="width: 100%; height: 500px;">
    ...
    <div class="ls-slide" style="slidedirection: right; transition2d: 92,93,105; ">
        ...
        <img src="frontend/assets/img/mockup/mea_fund_logo.png" alt="Slider Image" class="ls-s-1" style=" top:30px; left: 600px; slidedirection : right; slideoutdirection : bottom; durationin : 3000; durationout : 3000; ">
    </div>
    <!-- End First slide -->
...
{{--<div class="slider-inner">--}}
    {{--<div id="da-slider" class="da-slider">--}}
        {{--<div class="da-slide">--}}
            ...
            {{--<div class="da-img"><img class="img-responsive" src="frontend/assets/plugins/parallax-slider/img/1.png" alt=""></div>--}}
        {{--</div>--}}
        {{--<div class="da-slide">--}}
        ...
        {{--<div class="da-slide">--}}
            ...
            {{--<p><i>Lorem ipsum dolor amet</i> <br /> <i>tempor incididunt ut</i> <br /> <i>veniam omnis </i></p>--}}
            {{--<div class="da-img"><img src="frontend/assets/plugins/parallax-slider/img/html5andcss3.png" alt="image01" /></div>--}}
        {{--</div>--}}
        {{--<div class="da-arrows">--}}
